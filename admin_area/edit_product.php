          ...
          <form action="#" class="form-horizental" method="post" enctype="multipart/form-data">
           ...
           <?php
            if(isset($_POST['update'])){
              ...
              $update_product="UPDATE product SET p_cat_Id='$product_cat',date='NOW()',cat_id='$cat',product_title='$product_title',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',product_keyword='$product_keyword',product_desc='$product_desc' WHERE product_id='$edit_id' ";
